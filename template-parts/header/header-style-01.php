...
<div class="header-style-04">
    ...
    <nav class="navbar navbar-area navbar-expand-lg navigation-style-02 <?php echo esc_attr($has_top_bar); ?>">
        <div class="container custom-container">
            ...
            <div class="nav-right-content">
                <div class="btn-wrap">
                    <a href="<?php echo esc_url(cs_get_option('header_five_navbar_url')) ?>"
                       class="boxed-btn btn-rounded"><?php echo esc_html(cs_get_option('header_five_navbar_title')); ?>
                    </a>
                </div>
            </div>
        </div>
